...
module lab7_soc_mm_interconnect_0 (
	...
	wire   [17:0] cmd_mux_006_src_channel;                                                            // cmd_mux_006:src_channel -> led_s1_agent:cp_channel
	...
	wire          cmd_mux_015_src_valid;                                                              // cmd_mux_015:src_valid -> stopwatch_s1_agent:cp_valid
	wire  [107:0] cmd_mux_015_src_data;                                                               // cmd_mux_015:src_data -> stopwatch_s1_agent:cp_data
	wire          cmd_mux_015_src_ready;                                                              // stopwatch_s1_agent:cp_ready -> cmd_mux_015:src_ready
	wire   [17:0] cmd_mux_015_src_channel;                                                            // cmd_mux_015:src_channel -> stopwatch_s1_agent:cp_channel
	wire          cmd_mux_015_src_startofpacket;                                                      // cmd_mux_015:src_startofpacket -> stopwatch_s1_agent:cp_startofpacket
	wire          cmd_mux_015_src_endofpacket;                                                        // cmd_mux_015:src_endofpacket -> stopwatch_s1_agent:cp_endofpacket
	...
	wire          cmd_mux_016_src_valid;                                                              // cmd_mux_016:src_valid -> sw_reset_s1_agent:cp_valid
	wire  [107:0] cmd_mux_016_src_data;                                                               // cmd_mux_016:src_data -> sw_reset_s1_agent:cp_data
	wire          cmd_mux_016_src_ready;                                                              // sw_reset_s1_agent:cp_ready -> cmd_mux_016:src_ready
	wire   [17:0] cmd_mux_016_src_channel;                                                            // cmd_mux_016:src_channel -> sw_reset_s1_agent:cp_channel
	wire          cmd_mux_016_src_startofpacket;                                                      // cmd_mux_016:src_startofpacket -> sw_reset_s1_agent:cp_startofpacket
	wire          cmd_mux_016_src_endofpacket;                                                        // cmd_mux_016:src_endofpacket -> sw_reset_s1_agent:cp_endofpacket
	...
	wire          stopwatch_s1_agent_rp_valid;                                                        // stopwatch_s1_agent:rp_valid -> router_017:sink_valid
	wire  [107:0] stopwatch_s1_agent_rp_data;                                                         // stopwatch_s1_agent:rp_data -> router_017:sink_data
	wire          stopwatch_s1_agent_rp_ready;                                                        // router_017:sink_ready -> stopwatch_s1_agent:rp_ready
	wire          stopwatch_s1_agent_rp_startofpacket;                                                // stopwatch_s1_agent:rp_startofpacket -> router_017:sink_startofpacket
	wire          stopwatch_s1_agent_rp_endofpacket;                                                  // stopwatch_s1_agent:rp_endofpacket -> router_017:sink_endofpacket
	...
	wire          sw_reset_s1_agent_rp_valid;                                                         // sw_reset_s1_agent:rp_valid -> router_018:sink_valid
	wire  [107:0] sw_reset_s1_agent_rp_data;                                                          // sw_reset_s1_agent:rp_data -> router_018:sink_data
	wire          sw_reset_s1_agent_rp_ready;                                                         // router_018:sink_ready -> sw_reset_s1_agent:rp_ready
	wire          sw_reset_s1_agent_rp_startofpacket;                                                 // sw_reset_s1_agent:rp_startofpacket -> router_018:sink_startofpacket
	wire          sw_reset_s1_agent_rp_endofpacket;                                                   // sw_reset_s1_agent:rp_endofpacket -> router_018:sink_endofpacket
	...
	wire          stopwatch_s1_agent_rdata_fifo_src_valid;                                            // stopwatch_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_015:in_0_valid
	wire   [33:0] stopwatch_s1_agent_rdata_fifo_src_data;                                             // stopwatch_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_015:in_0_data
	wire          stopwatch_s1_agent_rdata_fifo_src_ready;                                            // avalon_st_adapter_015:in_0_ready -> stopwatch_s1_agent:rdata_fifo_src_ready
	wire          avalon_st_adapter_015_out_0_valid;                                                  // avalon_st_adapter_015:out_0_valid -> stopwatch_s1_agent:rdata_fifo_sink_valid
	wire   [33:0] avalon_st_adapter_015_out_0_data;                                                   // avalon_st_adapter_015:out_0_data -> stopwatch_s1_agent:rdata_fifo_sink_data
	wire          avalon_st_adapter_015_out_0_ready;                                                  // stopwatch_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_015:out_0_ready
	wire    [0:0] avalon_st_adapter_015_out_0_error;                                                  // avalon_st_adapter_015:out_0_error -> stopwatch_s1_agent:rdata_fifo_sink_error
	wire          sw_reset_s1_agent_rdata_fifo_src_valid;                                             // sw_reset_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_016:in_0_valid
	wire   [33:0] sw_reset_s1_agent_rdata_fifo_src_data;                                              // sw_reset_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_016:in_0_data
	wire          sw_reset_s1_agent_rdata_fifo_src_ready;                                             // avalon_st_adapter_016:in_0_ready -> sw_reset_s1_agent:rdata_fifo_src_ready
	wire          avalon_st_adapter_016_out_0_valid;                                                  // avalon_st_adapter_016:out_0_valid -> sw_reset_s1_agent:rdata_fifo_sink_valid
	wire   [33:0] avalon_st_adapter_016_out_0_data;                                                   // avalon_st_adapter_016:out_0_data -> sw_reset_s1_agent:rdata_fifo_sink_data
	wire          avalon_st_adapter_016_out_0_ready;                                                  // sw_reset_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_016:out_0_ready
	wire    [0:0] avalon_st_adapter_016_out_0_error;                                                  // avalon_st_adapter_016:out_0_error -> sw_reset_s1_agent:rdata_fifo_sink_error
	...
	lab7_soc_mm_interconnect_0_router_009 router_009 (
	...
	lab7_soc_mm_interconnect_0_avalon_st_adapter_007 #(
		.inBitsPerSymbol (18),
		.inUsePackets    (0),
		.inDataWidth     (18),
		.inChannelWidth  (0),
